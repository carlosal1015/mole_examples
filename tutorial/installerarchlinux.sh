...
# [2 / 3] Install armadillo from |\href{https://aur.archlinux.org/packages/armadillo}{https://aur.archlinux.org/armadillo.git}|
git clone https://aur.archlinux.org/armadillo.git
pushd armadillo
makepkg -s --noconfirm
popd

# [3 / 3] Install MOLE C++/Octave from |\href{https://aur.archlinux.org/packages/libmole}{https://aur.archlinux.org/libmole.git}|
