\part{Practical Exercises with MOLE}
...
% TODO: Crear tablas por categorías
...
% 		Program                                                                                                                    & Description \\
% 		\midrule
% 		\href{https://github.com/csrc-sdsu/mole/blob/master/examples/matlab/backward_euler.m}{\mintinline{text}|backward_euler.m|} & Programa    \\
% 		\mintinline{text}|burgers1D.m|                                                                                             & Programa    \\
% 		\mintinline{text}|compact_operators|                                                                                       & Programa    \\
% 		\mintinline{text}|convection_diffusion3D.m|                                                                                & Programa    \\
% 		\mintinline{text}|elliptic1DaddBC.m|                                                                                       & Programa    \\
% 		\mintinline{text}|elliptic1DHomogeneousDirichlet.m|                                                                        & Programa    \\
% 		\mintinline{text}|elliptic1DLeftDirichletRightNeumann.m|                                                                   & Programa    \\
% 		\mintinline{text}|elliptic1DLeftDirichletRightRobin.m|                                                                     & Programa    \\
% 		\mintinline{text}|elliptic1DLeftNeumannRightNeumann.m|                                                                     & Programa    \\
% 		\mintinline{text}|elliptic1DLeftNeumannRightRobin.m|                                                                       & Programa    \\
% 		\mintinline{text}|elliptic1DLeftRobinRightRobin.m|                                                                         & Programa    \\
% 		\mintinline{text}|elliptic1D.m|                                                                                            & Programa    \\
% 		\mintinline{text}|elliptic1DNonHomogeneousDirichlet.m|                                                                     & Programa    \\
% 		\mintinline{text}|elliptic1DPeriodicBC.m|                                                                                  & Programa    \\
% 		\mintinline{text}|elliptic2D_case2.m|                                                                                      & Programa    \\
% 		\mintinline{text}|elliptic2D.m|                                                                                            & Programa    \\
% 		\mintinline{text}|elliptic2D_nodal_curv.m|                                                                                 & Programa    \\
% 		\mintinline{text}|elliptic2D_nodal_curv_sinusoidal.m|                                                                      & Programa    \\
% 		\mintinline{text}|elliptic2DXDirichletYDirichlet.m|                                                                        & Programa    \\
% 		\mintinline{text}|elliptic2DXPeriodicYPeriodic.m|                                                                          & Programa    \\
% 		\mintinline{text}|elliptic3DaddBC.m|                                                                                       & Programa    \\
% 		\mintinline{text}|elliptic3D.m|                                                                                            & Programa    \\
% 		\mintinline{text}|elliptic3DXDirichletYDirichletZDirichlet.m|                                                              & Programa    \\
% 		\mintinline{text}|elliptic3DXDirichletYPeriodicZPeriodic.m|                                                                & Programa    \\
% 		\mintinline{text}|elliptic3DXNeumannYPeriodicZPeriodic.m|                                                                  & Programa    \\
% 		\mintinline{text}|genCurvGrid.m|                                                                                           & Programa    \\
% 		\mintinline{text}|helmholtz2D_wifi.m|                                                                                      & Programa    \\
% 		\mintinline{text}|hyperbolic1D_lax_friedrichs.m|                                                                           & Programa    \\
% 		\mintinline{text}|hyperbolic1D.m|                                                                                          & Programa    \\
% 		\mintinline{text}|hyperbolic1D_upwind.m|                                                                                   & Programa    \\
% 		\mintinline{text}|KG_product.m|                                                                                            & Programa    \\
% 		\mintinline{text}|lock_exchange.m|                                                                                         & Programa    \\
% 		\mintinline{text}|minimal_poisson2D.m|                                                                                     & Programa    \\
% 		\mintinline{text}|parabolic1D.m|                                                                                           & Programa    \\
% 		\mintinline{text}|richards.m|                                                                                              & Programa    \\
% 		\mintinline{text}|RK2.m|                                                                                                   & Programa    \\
% 		\mintinline{text}|RK4.m|                                                                                                   & Programa    \\
% 		\mintinline{text}|schrodinger2D.m|                                                                                         & Programa    \\
% 		\mintinline{text}|sturmLiouvilleBessel.m|                                                                                  & Programa    \\
% 		\mintinline{text}|sturmLiouvilleChebyshev.m|                                                                               & Programa    \\
% 		\mintinline{text}|sturmLiouvilleHelmholtzDirichletDirichlet.m|                                                             & Programa    \\
% 		\mintinline{text}|sturmLiouvilleHelmholtzDirichletRobin.m|                                                                 & Programa    \\
% 		\mintinline{text}|sturmLiouvilleHermite.m|                                                                                 & Programa    \\
% 		\mintinline{text}|sturmLiouvilleLaguerre.m|                                                                                & Programa    \\
% 		\mintinline{text}|sturmLiouvilleLegendre.m|                                                                                & Programa    \\
% 		\mintinline{text}|test_curl.m|                                                                                             & Programa    \\
% 		\mintinline{text}|test_div2DCurv.m|                                                                                        & Programa    \\
% 		\mintinline{text}|test_div3DCurv.m|                                                                                        & Programa    \\
% 		\mintinline{text}|test_grad2DCurv.m|                                                                                       & Programa    \\
% 		\mintinline{text}|test_grad3DCurv.m|                                                                                       & Programa    \\
% 		\mintinline{text}|test_lap3DCurv_case2.m|                                                                                  & Programa    \\
% 		\mintinline{text}|test_lap3DCurv.m|                                                                                        & Programa    \\
% 		\mintinline{text}|test_nodal2DCurv.m|                                                                                      & Programa    \\
% 		\mintinline{text}|van_der_pol.m|                                                                                           & Programa    \\
% 		\mintinline{text}|wave1D_case2.m|                                                                                          & Programa    \\
% 		\mintinline{text}|wave1D.m|                                                                                                & Programa    \\
% 		\mintinline{text}|wave1DTimeVaryingBC.m|                                                                                   & Programa    \\
% 		\mintinline{text}|wave2D_case2.m|                                                                                          & Programa    \\
% 		\mintinline{text}|wave2D.m|                                                                                                & Programa    \\
% 		\bottomrule
% 	\end{tabular}
% \end{table}
...
\subsection{Animating the Transport Equation}
...
\begin{pythonlisting}
	\tiny
	\centering
	\pathinputminted[frame=single,framesep=10pt,linenos,firstline=1,lastline=23,highlightlines={13}]{python}{elliptic1D.py}
	\caption{Program~\texttt{elliptic1D.py}}
	\label{code:elliptic1D.py}
\end{pythonlisting}
...
\begin{itemize}
	...
	\item
	      ...
	      \begin{figure}[ht!]
		      \centering
		      \includegraphics[width=.4\paperwidth]{mldivide_sparse}
...
\begin{octavelisting}
	\tiny
	\centering
	\pathinputminted[frame=single,framesep=12pt,linenos,firstline=33,lastline=55,highlightlines={20,29}]{octave}{convection_diffusion.m}
	\caption{Program~\texttt{convection\_diffusion.m}}
	\label{code:convection_diffusion.m}
\end{octavelisting}
