...
% \section{Best Practices for Code Translation}
...
% \section{Armadillo / Eigen (C++)}
% \section{SciPy / NumPy (Python)}
% \section{Julia / Fortran / Rust Examples}
...
\section{SciPy Sparse~\textcolor{blue}{\faIcon{python}}}
...
\section{Sparse Linear Algebra in Rust~\faIcon{rust}}
