 ...
 * @brief Solves a 3D Convection-Diffusion equation using Mimetic Operators for
 * Linear Equations (MOLE).
 *
 * This program numerically solves the 3D convection-diffusion equation using
 * MOLE techniques. It simulates the distribution of CO2 concentration over time
 * within a porous medium, considering both diffusion and advection effects.
 *
 * If OUTPUT_FRAME_DATA is set to 1, slices (2D cross-sections) of the
 * concentration field are extracted and saved to a text file for visualization.
 */
