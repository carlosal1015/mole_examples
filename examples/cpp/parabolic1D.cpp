...
int main()
{
   ...
   *changed or the final time is changed the final time tf may not be a multiple
   *of dt. This value of dt guarantees that the final time will be a mutiple of
   *dt. while still satisfying Von Neumann stablity criterion Note that in this
